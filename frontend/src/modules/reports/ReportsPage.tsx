    ...
    <section>
      ...
      <div className="card form filters-card">
        ...
        >
          ...
          <span className={filtersOpen ? 'filters-toggle-icon open' : 'filters-toggle-icon'}>▾</span>
        </button>

        <div className={filtersOpen ? 'filters-body open' : 'filters-body'}>
        ...
        {activeTab === 'person' && (
          <div className="reports-content">
            {personTotals && personTotals.items.length > 0 ? (
              ...
              <p className="reports-empty">Nenhuma transação cadastrada para cálculo de totais por pessoa.</p>
            )}
          </div>
        )}
        ...
        {activeTab === 'category' && (
          <div className="reports-content">
            {categoryTotals && categoryTotals.items.length > 0 ? (
              ...
              <p className="reports-empty">Nenhuma transação cadastrada para cálculo de totais por categoria.</p>
            )}
          </div>
        )}
      </div>
